  ...
  if (!result) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
        ...
        <p className="text-base-content/60 text-sm">No result found.</p>
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-2 pb-6">
          <Link href={`/child/lessons/${encodedSubject}/${encodedTopic}`} className="btn btn-primary w-full">
            Back to Topics
          </Link>
          <Link href={`/child/lessons/${encodedSubject}/${encodedTopic}/${quest_id}`} className="btn btn-ghost w-full">
            Try Again
          </Link>
